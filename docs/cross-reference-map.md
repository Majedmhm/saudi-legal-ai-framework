...
## 5. Datasets ← → Enums / قواعد البيانات ← → القيم المضبوطة
...
## 6. Datasets ← → Scripts / قواعد البيانات ← → السكربتات
...
## 7. Workflows ← → GitHub Actions / سير العمل ← → الإجراءات الآلية
...
## 8. قواعد الصيانة / Maintenance Rules
...
*آخر تحديث / Last updated: 2026-05-16 — يعكس حالة المشروع في v0.1*
